...
const certifications = [
  { name: "Google Cloud Digital Leader", issuer: "Google Cloud", color: "from-blue-500 to-cyan-500" },
  { name: "AWS Academy Graduate – Cloud Foundations", issuer: "Amazon Web Services", color: "from-amber-500 to-orange-500" },
  { name: "SQL (Basic) & SQL (Advanced)", issuer: "HackerRank", color: "from-emerald-500 to-teal-500" },
  { name: "Python Basic Certificate", issuer: "HackerRank", color: "from-yellow-500 to-lime-500" },
  { name: "Java Training", issuer: "Professional Certification", color: "from-rose-500 to-pink-500" },
];
              ...
              <div className="space-y-3">
                {certifications.map((cert, i) => (
                  <motion.div
                    ...
                    className="group relative flex items-center gap-4 p-5 rounded-2xl dark:glass-card glass-card-light neon-border hover:border-primary-500/20 transition-all duration-500 cursor-default"
                  >
